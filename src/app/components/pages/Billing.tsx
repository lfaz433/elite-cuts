        ...
        {success && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-green-400/80">Merci pour votre confiance. Votre salon Elite Cuts est maintenant entièrement opérationnel.</p>
            </div>
          </motion.div>
        )}
          ...
          <div className={`bg-gradient-to-br from-[#141414] to-[#0d0d0d] border rounded-3xl p-8 flex flex-col justify-between transition-all relative ${
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3.5">
                ...
                <li className="flex items-center gap-2.5 text-sm text-white/60">
                  <Check className="w-4 h-4 text-[#D4AF37]" />
                  <span>Widget de réservation Elite Cuts</span>
                </li>
                <li className="flex items-center gap-2.5 text-sm text-white/60">
                  <Check className="w-4 h-4 text-[#D4AF37]" />
