    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-white/50 text-sm">Seuls les super-administrateurs d'Elite Cuts peuvent accéder à cet espace.</p>
        </div>
      </div>
    );
  }
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-12">
                  <form onSubmit={grantFreeAccessForm} className="bg-[#111] border border-white/10 p-8 rounded-3xl max-w-xl space-y-6">
                    <div>
                      ...
                      <p className="text-sm text-white/50 mb-6">Permet à un salon d'utiliser Elite Cuts gratuitement à vie avec le plan choisi.</p>
                    </div>
